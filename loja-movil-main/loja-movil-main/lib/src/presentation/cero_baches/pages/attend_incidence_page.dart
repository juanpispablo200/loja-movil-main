...
class AttendIncidencePage extends StatefulWidget {
  final Object? incidenceId;

  const AttendIncidencePage({super.key, required this.incidenceId});

  static const routeName = '/attend_incidence';
  static const String name = 'attend_incidence-page';

  @override
  State<AttendIncidencePage> createState() => _AttendIncidencePage();
}

class _AttendIncidencePage extends State<AttendIncidencePage> {
  File? imageFile;
  ...
  bool _disabledButton() {
    return description != '' && selectedValue != null && imageFile != null;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return LoadingView(
      isLoading: provider.loadingAttend,
                  ...
                  child: DecoratedBox(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButton(
                        ...
                        items: provider.statusByRole.map((item) {
                          return DropdownMenuItem(
                            value: item,
                            child: Text(item.name),
                          );
                        }).toList(),
                        onChanged: (IncidenceStatus? value) {
                          setState(() {
                            selectedValue = value;
                          });
                        },
                  ...
                  onPressed: !_disabledButton()
                      ...
                      : () async {
                          ...
                          Map<String, dynamic> request = {
                            ...
                            'incidenceIds': widget.incidenceId
                          };

                          bool result = await provider.attendIncidence(request);
                          if (result) {
                            ...
                            showTopSnackBar(
                              ...
                              const CustomSnackBar.error(
                                message:
                                    'Error al actualizar la incidencia, intente nuevamente',
                              ),
                            );
                          }
                        },
